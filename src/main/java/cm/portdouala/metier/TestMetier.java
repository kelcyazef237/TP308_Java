...
import cm.portdouala.metier.metier.ConteneurRefrigere;
import cm.portdouala.metier.metier.ConteneurStandard;
import cm.portdouala.metier.metier.GestionPortuaire;
...
public class TestMetier {
    ...
    private static void testValidations() {
        ...
        // Temperature min >= max
        try {
            new cm.portdouala.metier.metier.ConteneurRefrigere(2, 100, "Fruits", 10, 5);
        ...
        try {
            new cm.portdouala.metier.metier.ConteneurRefrigere(3, 100, "Viande", 0, 10, 20);
    ...
    private static void testTaxes() {
        ...
        cm.portdouala.metier.metier.ConteneurRefrigere cr = new cm.portdouala.metier.metier.ConteneurRefrigere(11, 800, "Aliments", -5, 5);
    ...
    private static void testAlertes() {
        ...
        cm.portdouala.metier.metier.ConteneurRefrigere cr = new cm.portdouala.metier.metier.ConteneurRefrigere(20, 500, "Medicaments", 2, 8);
    ...
    private static void testFiltresEtCollections() {
        ...
        cm.portdouala.metier.metier.ConteneurRefrigere r1 = new cm.portdouala.metier.metier.ConteneurRefrigere(2, 200, "Poissons", -10, 0);
        cm.portdouala.metier.metier.ConteneurRefrigere r2 = new cm.portdouala.metier.metier.ConteneurRefrigere(3, 300, "Fruits", 0, 10);
        ...
        List<cm.portdouala.metier.metier.ConteneurRefrigere> alertes = gp.getCargaisonsEnAlerte();
        ...
        List<cm.portdouala.metier.metier.ConteneurRefrigere> refs = gp.getConteneursRefrigeres();
        if (refs.size() == 2) {
